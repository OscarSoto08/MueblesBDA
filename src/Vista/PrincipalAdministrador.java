...
public class PrincipalAdministrador extends javax.swing.JFrame {
  ...
  public PrincipalAdministrador() {
        ...
        mueble = new Muebles();
        mueble.setBounds(230, 0, 800, 1200);
        add(mueble);
         mueble.setVisible(false);

        cliente = new Cliente();
        cliente.setBounds(230, 0, 800, 1200); 
        add(cliente);

        cliente.setVisible(false); 
        
        empleado = new Empleados();
        empleado.setBounds(230, 0, 800, 1200); 
        add(empleado);

        empleado.setVisible(false); 

        proveedor = new Proveedor();
        proveedor.setBounds(230, 0, 800, 1200); 
        add(proveedor);

        proveedor.setVisible(false); 
        
        inventario = new Inventario();
        inventario.setBounds(230, 0, 800, 1200);
        add(inventario);
